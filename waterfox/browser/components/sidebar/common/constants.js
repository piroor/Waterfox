...
export const kCOMMAND_GET_CONTEXTUAL_IDENTITIES_COLOR_INFO =
  "ws:get-contextual-identities-color-info";
...
export const kCOMMAND_REMOVE_TABS_BY_MOUSE_OPERATION =
  "ws:remove-tabs-by-mouse-operation";
...
export const kCOMMAND_NOTIFY_TAB_INTERNALLY_MOVED =
  "ws:notify-tab-internally-moved";
...
export const kCOMMAND_NOTIFY_MAY_START_TAB_SWITCH =
  "ws:notify-may-start-tab-switch";
export const kCOMMAND_NOTIFY_MAY_END_TAB_SWITCH =
  "ws:notify-may-end-tab-switch";
export const kCOMMAND_NOTIFY_TAB_ATTACHED_TO_WINDOW =
  "ws:notify-tab-attached-to-window";
export const kCOMMAND_NOTIFY_TAB_DETACHED_FROM_WINDOW =
  "ws:notify-tab-detached-from-window";
export const kCOMMAND_NOTIFY_PERMISSIONS_GRANTED =
  "ws:notify-permissions-granted";
...
export const kCOMMAND_NOTIFY_TAB_FAVICON_UPDATED =
  "ws:notify-tab-favicon-updated";
export const kCOMMAND_NOTIFY_TAB_SOUND_STATE_UPDATED =
  "ws:notify-tab-sound-state-updated";
export const kCOMMAND_NOTIFY_TAB_SHARING_STATE_UPDATED =
  "ws:notify-tab-sharing-state-updated";
export const kCOMMAND_NOTIFY_TABS_CLOSING = "ws:notify-tabs-closing";
export const kCOMMAND_NOTIFY_HIGHLIGHTED_TABS_CHANGED =
  "ws:notify-highlighted-tabs-changed";
export const kCOMMAND_NOTIFY_TABS_HIGHLIGHTING_IN_PROGRESS =
  "ws:notify-tabs-highlighting-in-progress";
export const kCOMMAND_NOTIFY_TABS_HIGHLIGHTING_COMPLETE =
  "ws:notify-tabs-highlighting-complete";
export const kCOMMAND_NOTIFY_GROUP_TAB_DETECTED =
  "ws:notify-group-tab-detected";
export const kCOMMAND_NOTIFY_CHILDREN_CHANGED = "ws:notify-children-changed";
export const kCOMMAND_NOTIFY_TAB_COLLAPSED_STATE_CHANGED =
  "ws:notify-tab-collapsed-state-changed";
export const kCOMMAND_NOTIFY_SUBTREE_COLLAPSED_STATE_CHANGED =
  "ws:notify-subtree-collapsed-state-changed";
export const kCOMMAND_SET_SUBTREE_COLLAPSED_STATE =
  "ws:set-subtree-collapsed-state";
export const kCOMMAND_SET_SUBTREE_COLLAPSED_STATE_INTELLIGENTLY_FOR =
  "ws:set-subtree-collapsed-state-intelligently-for";
...
export const kCOMMAND_NOTIFY_TAB_ATTACHED_COMPLETELY =
  "ws:notify-tab-attached-completely";
export const kCOMMAND_BROADCAST_CURRENT_DRAG_DATA =
  "ws:broadcast-current-drag-data";
...
export const kCOMMAND_REQUEST_CONNECTION_MESSAGE_LOGS =
  "ws:request-connection-message-logs";
export const kCOMMAND_RESPONSE_CONNECTION_MESSAGE_LOGS =
  "ws:response-connection-message-logs";
...
export const kCOMMAND_NOTIFY_CONTEXT_ITEM_CHECKED_STATUS_CHANGED =
  "ws:contextMenu-item-checked-status-changed";
export const kCOMMAND_NOTIFY_CONTEXT_OVERRIDDEN =
  "ws:notify-context-overridden";
export const kCOMMAND_AUTODETECT_DUPLICATED_TAB_DETECTION_DELAY =
  "ws:autodetect-duplicated-tab-detection-delay";
export const kCOMMAND_TEST_DUPLICATED_TAB_DETECTION =
  "ws:test-duplicated-tab-detection";
export const kCOMMAND_WAIT_UNTIL_SUCCESSORS_UPDATED =
  "ws:wait-until-successors-updated";
...
export const kCOMMAND_TOGGLE_MUTED_FROM_SOUND_BUTTON =
  "ws:toggle-muted-from-sound-button";
export const kCOMMAND_UNBLOCK_AUTOPLAY_FROM_SOUND_BUTTON =
  "ws:unblock-autoplay-from-sound-button";
...
export const kCOMMAND_BROADCAST_TAB_TOOLTIP_TEXT =
  "ws:broadcast-tab-tooltip-text";
export const kCOMMAND_BROADCAST_TAB_AUTO_STICKY_STATE =
  "ws:broadcast-tab-auto-sticky-state";

export const kCOMMAND_BOOKMARK_TAB_WITH_DIALOG = "ws:bookmark-tab-with-dialog";
export const kCOMMAND_BOOKMARK_TABS_WITH_DIALOG =
  "ws:bookmark-tabs-with-dialog";
...
export const kPERSISTENT_ALREADY_GROUPED_FOR_PINNED_OPENER =
...
export const kCONTEXTUAL_IDENTITY_SELECTOR_CONTEXT_MENU =
  "contextual-identities-selector-context";
...
export const kTAB_STATE_HAS_AUTOPLAY_BLOCKED_MEMBER =
  "has-autoplay-blocked-member";
...
export const kTAB_STATE_HAS_SHARING_MICROPHONE_MEMBER =
  "has-sharing-microphone-member";
...
export const kTAB_STATE_SOME_DESCENDANTS_HIGHLIGHTED =
  "some-descendants-highlighted";
export const kTAB_STATE_ALL_DESCENDANTS_HIGHLIGHTED =
  "all-descendants-highlighted";
...
export const kTAB_TEMPORARY_STATES = new Set([
  // states not trigger updating of cache
  kTAB_STATE_CREATING,
  kTAB_STATE_BURSTING,
  kTAB_STATE_COLLAPSING,
  kTAB_STATE_DUPLICATING,
...
export const kTABBAR_STATE_HAVE_UNSYNCHRONIZED_THROBBER =
  "have-unsynchronized-throbber";
export const kTABBAR_STATE_THROBBER_SYNCHRONIZING = "throbber-synchronizing";
export const kTABBAR_STATE_CONTEXTUAL_IDENTITY_SELECTABLE =
  "contextual-identity-selectable";
export const kTABBAR_STATE_NEWTAB_ACTION_SELECTABLE =
  "newtab-action-selectable";
...
export const kWINDOW_STATE_SUBPANEL_EFFECTIVE_HEIGHT =
  "subpanel-effective-height";
export const kWINDOW_STATE_CACHED_TABS = "cached-tabs";
export const kWINDOW_STATE_CACHED_SIDEBAR = "cached-sidebar-contents";
export const kWINDOW_STATE_CACHED_SIDEBAR_CONTENTS =
  "cached-sidebar-contents:contents";
export const kWINDOW_STATE_CACHED_SIDEBAR_TABS_DIRTY =
  "cached-sidebar-contents:tabs-dirty";
export const kWINDOW_STATE_CACHED_SIDEBAR_COLLAPSED_DIRTY =
  "cached-sidebar-contents:collapsed-dirty";
...
export const kGROUP_BOOKMARK_FIXED =
  kGROUP_BOOKMARK_SUBTREE | kGROUP_BOOKMARK_SEPARATE;
...
export const kGROUP_TAB_URI = browser.runtime.getURL(
  "resources/group-tab.html"
);
export const kGROUP_TAB_DEFAULT_TITLE_MATCHER = new RegExp(
  `^${browser.i18n.getMessage("groupTab_label", ".+")}$`
);
export const kGROUP_TAB_FROM_PINNED_DEFAULT_TITLE_MATCHER = new RegExp(
  `^${browser.i18n.getMessage("groupTab_fromPinnedTab_label", ".+")}$`
);
export const kSHORTHAND_CUSTOM_URI =
  /^ext\+ws:([^:?#]+)(?:[:?]([^#]*))?(#.*)?$/;
...
export const IS_BACKGROUND = location.href.startsWith(
  browser.runtime.getURL("background/background.html")
);
export const IS_SIDEBAR = location.href.startsWith(
  browser.runtime.getURL("sidebar/sidebar.html")
);

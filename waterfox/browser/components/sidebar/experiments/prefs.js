...
function initSidebarCategory(document, { locale, BASE_URL, BASE_PREF }) {
  ...
  if (document.querySelector("#category-tabsSidebar")) return true;

  const generalItem = document.querySelector("#category-general");
  if (!generalItem) return false;
  ...
  try {
    ...
    preferenceItems.appendChild(
      element(document, HTML, "template", {
      ...
      element(
        ...
        [
          element(document, XUL, "label", [
            element(document, HTML, "h2", [
              locale.get("preferences_appearanceGroup_caption"),
            ]),
          ]),
          element(
            document,
            XUL,
            "vbox",
            { id: "tabsSidebar_hideHorizontalTabsWhileActiveBox" },
            [
              element(document, XUL, "checkbox", {
                ...
                label: locale.get(
                  "preferences_hideHorizontalTabsWhileActive_label"
                ),
                accesskey: locale.get(
                  "preferences_hideHorizontalTabsWhileActive_accesskey"
                ),
              }),
            ]
          ),
          element(
            ...
            XUL,
            "vbox",
            { id: "tabsSidebar_faviconizePinnedTabsBox" },
            [
              element(document, XUL, "checkbox", {
                ...
                accesskey: locale.get(
                  "preferences_faviconizePinnedTabs_accesskey"
                ),
              }),
            ]
          ),
          element(
            ...
            XUL,
            "vbox",
            { id: "tabsSidebar_showTabPreviewBox" },
            [
              element(document, XUL, "checkbox", {
      ...
      element(
        ...
        [
          element(
            ...
            XUL,
            "label",
            { id: "tabsSidebar_stickyActiveTabBox_caption" },
            [
              element(document, HTML, "h2", [
                locale.get("config_autoStickyTab_caption"),
              ]),
            ]
          ),
          element(
            ...
            XUL,
            "vbox",
            { id: "tabsSidebar_stickyActiveTabBox" },
            [
              element(document, XUL, "checkbox", {
          ...
          element(
            ...
            XUL,
            "vbox",
            { id: "tabsSidebar_stickySoundPlayingTabBox" },
            [
              element(document, XUL, "checkbox", {
                ...
                accesskey: locale.get(
                  "preferences_stickySoundPlayingTab_accesskey"
                ),
              }),
            ]
          ),
          element(
            ...
            XUL,
            "vbox",
            { id: "tabsSidebar_stickySharingTabBox" },
            [
              element(document, XUL, "checkbox", {
    ...
    preferenceItems.appendChild(
      element(
        ...
        [
          element(document, XUL, "label", [
            element(document, HTML, "h2", [
              locale.get("preferences_treeBehaviorGroup_caption"),
            ]),
          ]),
          ...
          element(
            ...
            XUL,
            "vbox",
            { id: "tabsSidebar_autoCollapseExpandSubtreeOnAttachBox" },
            [
              element(document, XUL, "checkbox", {
                ...
                accesskey: locale.get(
                  "preferences_autoCollapseExpandSubtreeOnAttach_accesskey"
                ),
                class: "tree-option",
              }),
            ]
          ...
          element(
            ...
            XUL,
            "vbox",
            { id: "tabsSidebar_autoCollapseExpandSubtreeOnSelectBox" },
            [
              element(document, XUL, "checkbox", {
                ...
                accesskey: locale.get(
                  "preferences_autoCollapseExpandSubtreeOnSelect_accesskey"
                ),
                class: "tree-option",
              }),
            ]
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_treeDoubleClickBehavior_accesskey"
                  ),
                  class: "tree-option",
                },
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_successorTabControlLevel_accesskey"
                  ),
                  class: "tree-option",
                },
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_dropLinksOnTabBehavior_accesskey"
                  ),
                  class: "tree-option",
                },
    ...
    preferenceItems.appendChild(
      element(
        ...
        [
          element(document, XUL, "label", [
            element(document, HTML, "h2", [
              locale.get("preferences_autoAttachGroup_caption"),
            ]),
          ]),
          element(
            document,
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_autoAttachOnOpenedWithOwner_accesskey"
                  ),
                  class: "tree-option",
                },
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_insertNewTabFromPinnedTabAt_accesskey"
                  ),
                  class: "tree-option",
                },
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_autoAttachOnNewTabCommand_accesskey"
                  ),
                  class: "tree-option",
                },
                ...
                [
                  element(
                    ...
                    "label",
                    {
                      ...
                      control:
                        "tabsSidebar_autoAttachOnNewTabButtonMiddleClick",
                      accesskey: locale.get(
                        "preferences_autoAttachOnNewTabButtonMiddleClick_accesskey"
                      ),
                      class: "tree-option",
                    },
                    [
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_autoAttachOnDuplicated_accesskey"
                  ),
                  class: "tree-option",
                },
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_autoAttachSameSiteOrphan_accesskey"
                  ),
                  class: "tree-option",
                },
                [
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_autoAttachOnOpenedFromExternal_accesskey"
                  ),
                  class: "tree-option",
                },
                [
            ...
            [
              element(
                ...
                "label",
                {
                  ...
                  accesskey: locale.get(
                    "preferences_autoAttachOnAnyOtherTrigger_accesskey"
                  ),
                  class: "tree-option",
                },
                [
    ...
    for (const prefInfo of [
      ...
      {
        id: `${BASE_PREF}autoAttachOnNewTabButtonMiddleClick`,
        type: "unichar",
      },
    ...
    document.defaultView.gSidebarPage = {
      ...
      updateTreeOptions() {
        ...
        for (const node of document.querySelectorAll(
          '[data-category="paneTabsSidebar"] .tree-option'
        )) {
      ...
      openAdvancedOptions() {
        ...
        Services.wm.getMostRecentBrowserWindow().openLinkIn(url, "tab", {
          ...
          case "tabsSidebar_useTree":
            if (event.target.checked) {
              ...
              Services.prefs.setBoolPref(
                `${BASE_PREF}syncParentTabAndOpenerTab`,
                true
              );
    ...
    document.defaultView.register_module(
      "paneTabsSidebar",
      document.defaultView.gSidebarPage
    );
    ...
    if (document.URL.endsWith("#tabsSidebar")) {
      ...
      const initialize = () => {
        document
          ...
          .selectItem(document.querySelector("#category-tabsSidebar"));
...
function uninitSidebarCategory(document) {
  ...
  document.removeEventListener(
    "command",
    document.defaultView.gSidebarPage.onCommand
  );
  document.removeEventListener(
    "click",
    document.defaultView.gSidebarPage.onButtonClick
  );
  document.removeEventListener(
    "keydown",
    document.defaultView.gSidebarPage.onButtonKeyDown
  );
...
const AboutPreferencesWatcher = {
  WATCHING_URLS: ["about:preferences"],
  ...
  onPrefChanged(name) {
    switch (name) {
      case "browser.tabs.selectOwnerOnClose":
        Services.prefs.setBoolPref(
          `${this.BASE_PREF}simulateSelectOwnerOnClose`,
      ...
      case "browser.tabs.loadInBackground":
        Services.prefs.setBoolPref(
          `${this.BASE_PREF}simulateTabsLoadInBackgroundInverted`,
          Services.prefs.getBoolPref(name)
        );
        break;
      ...
      case "browser.tabs.warnOnClose":
        Services.prefs.setBoolPref(
          `${this.BASE_PREF}warnOnCloseTabs`,
          Services.prefs.getBoolPref(name)
        );
        break;
      ...
      case "browser.tabs.searchclipboardfor.middleclick":
        Services.prefs.setBoolPref(
          `${this.BASE_PREF}middleClickPasteURLOnNewTabButton`,
          Services.prefs.getBoolPref(name)
        );
        break;
      ...
      case "browser.tabs.insertRelatedAfterCurrent":
        {
          const insertAfterCurrent = Services.prefs.getBoolPref(
            "browser.tabs.insertAfterCurrent"
          );
          const insertRelatedAfterCurrent = Services.prefs.getBoolPref(
            "browser.tabs.insertRelatedAfterCurrent"
          );
          const useTree =
            Services.prefs.getBoolPref(`${this.BASE_PREF}autoAttach`, false) &&
            Services.prefs.getBoolPref(
              `${this.BASE_PREF}syncParentTabAndOpenerTab`,
              false
            );
          Services.prefs.setStringPref(
            `${this.BASE_PREF}autoAttachOnOpenedWithOwner`,
            !useTree
              ? -1
          ...
          Services.prefs.setStringPref(
            `${this.BASE_PREF}insertNewTabFromPinnedTabAt`,
            !useTree
              ? -1
              : insertRelatedAfterCurrent
                ? 3
          ...
          Services.prefs.setStringPref(
            `${this.BASE_PREF}insertNewTabFromFirefoxViewAt`,
            !useTree
              ? -1
              : insertRelatedAfterCurrent
                ? 3
...
this.prefs = class extends ExtensionAPI {
  getAPI(context) {
    ...
    const _extensionIDBase = context.extension.id.split("@")[0];
    ...
    while (windows.hasMoreElements()) {
      ...
      if (win.gBrowser) {
        // handle about:preferences in browser tabs
        for (const tab of win.gBrowser.tabs) {
          if (
            AboutPreferencesWatcher.WATCHING_URLS.some((url) =>
              tab.linkedBrowser.currentURI.spec.startsWith(url)
            )
          )
            AboutPreferencesWatcher.handleWindow(
      ...
      prefs: {
        onChanged: new EventManager({
          ...
          register: (fire) => {
            const observe = (_subject, _topic, data) => {
              fire
                .async(data.replace(AboutPreferencesWatcher.BASE_PREF, ""))
                .catch(() => {}); // ignore Message Manager disconnects
            };
            Services.prefs.addObserver(
              AboutPreferencesWatcher.BASE_PREF,
              observe
            );
            return () => {
        ...
        async getBoolValue(name, defaultValue = false) {
          try {
            return Services.prefs.getBoolPref(
              `${AboutPreferencesWatcher.BASE_PREF}${name}`,
              defaultValue
            );
          } catch (_error) {
            return defaultValue;
        ...
        async setDefaultBoolValue(name, value) {
          Services.prefs
            ...
            .setBoolPref(`${AboutPreferencesWatcher.BASE_PREF}${name}`, value);
        },
        ...
        async setDefaultIntValue(name, value) {
          Services.prefs
            .getDefaultBranch(null)
            .setIntPref(`${AboutPreferencesWatcher.BASE_PREF}${name}`, value);
        },
      },
    };
  }
    ...
    while (windows.hasMoreElements()) {
      ...
      for (const tab of win.gBrowser.tabs) {
        if (
          ...
          AboutPreferencesWatcher.unhandleWindow(
            tab.linkedBrowser.contentWindow
          );
      }
    }

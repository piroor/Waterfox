...
const mItems = [
  {
    ...
    children: [
      ...
      {
        title:
          indent() + browser.i18n.getMessage("config_animationForce_label"),
        key: "animationForce",
        type: "checkbox",
        expert: true,
      },
      ...
      },
      {
        ...
        get title() {
          return (
            ...
            configs.shiftTabsForScrollbarDistance +
            browser.i18n.getMessage(
  ...
  },
  {
    ...
    children: [
      ...
      {
        title:
          indent() + browser.i18n.getMessage("context_toggleSticky_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_reloadDescendants_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_unblockAutoplayTree_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_unblockAutoplayDescendants_command"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("context_toggleMuteTree_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_toggleMuteDescendants_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_closeDescendants_command"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("context_closeOthers_command"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("context_collapseTree_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_collapseTreeRecursively_command"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("context_collapseAll_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_expandTreeRecursively_command"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("context_bookmarkTree_command"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("context_sendTreeToDevice_command"),
        ...
        children: [
          ...
          },
          {
            title:
              ...
              " " +
              browser.i18n.getMessage("config_firefoxCompatible_choice"),
            key: "autoAttachOnContextNewTabCommand",
            value:
        ...
        children: [
          ...
          },
          {
            title:
              ...
              " " +
              browser.i18n.getMessage("config_recommended_choice"),
            key: "autoAttachOnOpenedWithOwner",
            value: Constants.kNEWTAB_OPEN_AS_CHILD_END,
            type: "radio",
          },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_autoAttachOnNewTabCommand_before"),
        children: [
          {
            title:
              browser.i18n.getMessage(
          ...
          },
          {
            title:
              ...
              delimiter +
              browser.i18n.getMessage("config_autoAttachOnNewTabCommand_after"),
            key: "autoAttachOnNewTabCommand",
            value: Constants.kNEWTAB_OPEN_AS_CHILD_TOP,
            type: "radio",
          },
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_longPressOnNewTabButton_before"),
        expert: true,
        children: [
          {
            title:
              ...
              delimiter +
              browser.i18n.getMessage("config_longPressOnNewTabButton_after"),
          ...
          {
            title:
              browser.i18n.getMessage("config_longPressOnNewTabButton_none") +
              delimiter +
              browser.i18n.getMessage("config_longPressOnNewTabButton_after"),
            key: "longPressOnNewTabButton",
            value: "",
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_autoAttachOnDuplicated_before"),
        expert: true,
        children: [
          {
            title:
              ...
              delimiter +
              browser.i18n.getMessage("config_autoAttachOnDuplicated_after"),
          ...
          {
            title:
              browser.i18n.getMessage("config_autoAttachOnDuplicated_sibling") +
              delimiter +
              browser.i18n.getMessage("config_autoAttachOnDuplicated_after"),
            key: "autoAttachOnDuplicated",
            value: Constants.kNEWTAB_OPEN_AS_SIBLING,
      ...
      {
        title:
          indent() + browser.i18n.getMessage("config_sameSiteOrphan_caption"),
        expert: true,
        children: [
          {
            title:
              ...
              delimiter +
              browser.i18n.getMessage("config_autoAttachSameSiteOrphan_after"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("config_fromExternal_caption"),
        expert: true,
        children: [
          {
            title:
      ...
      {
        title:
          indent() + browser.i18n.getMessage("config_anyOtherTrigger_caption"),
        expert: true,
        children: [
          {
            title:
          ...
          { type: "separator" },
          {
            ...
            get enabled() {
              return (
                configs.autoAttachOnAnyOtherTrigger !==
                Constants.kNEWTAB_DO_NOTHING
              );
            },
            children: [
              {
      ...
      },
      {
        ...
        get title() {
          return (
            ...
            delimiter +
            browser.i18n.getMessage("config_tabBunchesDetectionTimeout_after")
          );
        },
        enabled: false,
        expert: true,
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_autoGroupNewTabsFromBookmarks_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_autoGroupNewTabsFromOthers_label"),
      ...
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_warnOnAutoGroupNewTabs_label"),
      ...
      { type: "separator", expert: true },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_renderTreeInGroupTabs_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_groupTabTemporaryStateForAPI_label"),
        expert: true,
        children: [
          {
            title: browser.i18n.getMessage(
  ...
  },
  {
    ...
    children: [
      ...
      {
        title:
          indent() + browser.i18n.getMessage("config_tabDragBehavior_caption"),
        enabled: false,
      },
      // These options are too complex to put in the menu UI, so I simply redirect to the options page.
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_tabDragBehavior_label") +
          "...",
      ...
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_tabDragBehaviorShift_label") +
          "...",
        url: `${Constants.kSHORTHAND_URIS.options}#tabDragBehaviorConfigsGroup`,
      },
      {
      ...
      //{ type: 'separator' },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_dropLinksOnTabBehavior_caption"),
        enabled: false,
        expert: true,
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_dropLinksOnTabBehavior_ask"),
      ...
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_dropLinksOnTabBehavior_load"),
        key: "dropLinksOnTabBehavior",
      ...
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_dropLinksOnTabBehavior_newtab"),
        key: "dropLinksOnTabBehavior",
      ...
      //{ type: 'separator', expert: true },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_insertDroppedTabsAt_caption"),
        enabled: false,
        expert: true,
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_insertDroppedTabsAt_inherit"),
      ...
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_insertDroppedTabsAt_first"),
        key: "insertDroppedTabsAt",
        value: Constants.kINSERT_TOP,
        type: "radio",
        expert: true,
      ...
      {
        title:
          indent(2) + browser.i18n.getMessage("config_insertDroppedTabsAt_end"),
        key: "insertDroppedTabsAt",
        value: Constants.kINSERT_END,
        type: "radio",
        expert: true,
      ...
      //{ type: 'separator', expert: true },
      {
        ...
        get title() {
          return (
            ...
            delimiter +
            browser.i18n.getMessage("config_autoExpandOnLongHoverDelay_after")
          );
        },
      ...
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_autoExpandIntelligently_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_ignoreTabDropNearSidebarArea_label"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("config_warnOnCloseTabs_label"),
        key: "warnOnCloseTabs",
        type: "checkbox",
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_warnOnCloseTabsByClosebox_label"),
      ...
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_warnOnCloseTabsWithListing_label"),
      ...
      {
        title:
          indent(2) + browser.i18n.getMessage("config_persistCachedTree_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_supportTabsMultiselect_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_undoMultipleTabsClose_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_enableLinuxBehaviors_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_enableMacOSBehaviors_label"),
      ...
      },
      {
        title:
          indent() +
          browser.i18n.getMessage("config_enableWindowsBehaviors_label"),
      ...
      {
        title:
          indent() + browser.i18n.getMessage("config_loggingQueries_label"),
        key: "loggingQueries",
        type: "checkbox",
        expert: true,
      },
      {
        title:
          indent(2) +
          browser.i18n.getMessage("config_loggingConnectionMessages_label"),
...
function createItem(id, item, parent) {
  ...
  if ("enabled" in item) params.enabled = item.enabled;
  log("create: ", params);
  id = browser.menus.create(params);
  if (item.expert) mExpertItems.add(id);
  if (item.children) {
...
if (
  ...
  browser.browserAction /* Manifest V3 */
) {
  ...
  browser.menus.onShown.addListener((info, _tab) => {
    if (!info.contexts.includes(MENU_CONTEXT)) return;
    ...
    for (const item of mUpdatableItemsById.values()) {
      ...
      if (item.type === "checkbox" || item.type === "radio") {
        const checkedFromConfigs =
          "value" in item
            ? configs[item.key] === item.value
            : configs[item.key];
        params.checked = checkedFromConfigs;
        if (item.permissions) {
          Permissions.isGranted(item.permissions).then(async (granted) => {
            if (item.checked === granted) return;
            item.checked = granted && (!("key" in item) || checkedFromConfigs);
            await browser.menus
              .update(item.id, { checked: granted })
      ...
      if ("visible" in item) params.visible = item.visible;
      if ("checked" in params || "title" in params) {
        browser.menus
          .update(item.id, params)
          .catch(ApiTabs.createErrorSuppressor());
        updated = true;
      }
    }
    ...
    if (item.permissions) {
      if (item.checked) {
        browser.permissions
          ...
          .catch(ApiTabs.createErrorSuppressor());
        if (item.key && !("value" in item)) configs[item.key] = false;
      } else {
        browser.permissions
  ...
  configs.$addObserver((key) => {
    if (key === "showExpertOptions") updateExpertOptionsVisibility();
  });
